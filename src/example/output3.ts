...
export type Component =
	...
	| { type: 'Position'; val: Position }
	| { type: 'Rotation'; val: Rotation }
	| { type: 'Size3D'; val: Size3D }
	| { type: 'Size1D'; val: Size1D }
	| { type: 'EntityEvent'; val: EntityEvent }
	| { type: 'EntityState'; val: EntityState }
	| { type: 'ChatList'; val: ChatList }
export type Entity = {
	entityId: number
